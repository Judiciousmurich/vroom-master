  ...
  return (
    <>
      <div className="flex gap-4 px-8">
        <div className="grid grid-cols-4 bg-white border rounded-[20px]  gap-10  mb-6 w-[80%]">
          <div className="flex  justify-between items-center border-r-2 p-4">
            <div className="">
        ...
        <button className="mb-6 px-6 py-1 flex bg-[#415ff2] text-white items-center justify-center rounded-[20px] gap-4 w-[20%]"> <FaSearch />Search</button>
